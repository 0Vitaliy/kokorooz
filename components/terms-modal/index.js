    ...
    <ModalWrap isOpen={isOpen} onClose={onClose} title='Terms of use'>
      <>
        ...
        <p className={styles.textPrivacyPolicy}>
          ...
          зобовязуючу угоду між вами та розробниками додатку `Кокоруз` (надалі -
          `Ми`, `Наш`, `Розробник`), що регулює ваш доступ та використання
          додатку `Кокоруз` (надалі - `Додаток`).{' '}
        </p>
        <p className={styles.textPrivacyPolicy}>
          1.2. Перед використанням Додатка ви зобовязані уважно прочитати ці
          ...
          юридично зобовязуючу угоду з Розробником.
        </p>{' '}
        ...
        <p className={styles.textPrivacyPolicy}>
          ...
          точність вашої пропозиції. Ви зобовязуєтесь не розміщувати образливий,
          непристойний, незаконний або шкідливий контент.{' '}
        </p>{' '}
